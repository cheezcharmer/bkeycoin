...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid neuralinkbrainkeycoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid neuralinkbrainkeycoin address" in e.error['message'])
