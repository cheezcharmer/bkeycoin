...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s neuralinkbrainkeycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  neuralinkbrainkeycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded neuralinkbrainkeycoin transaction") + "\n" +
              "  neuralinkbrainkeycoin-tx [options] -create [commands]   " + _("Create hex-encoded neuralinkbrainkeycoin transaction") + "\n" +
              "\n";
