...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("178.62.104.210", "178.62.104.210", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("neuralinkbrainkeycointools.com", "dnsseed.neuralinkbrainkeycointools.com"));
        //vSeeds.push_back(CDNSSeedData("neuralinkbrainkeycoinpool.org", "dnsseed.neuralinkbrainkeycoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("178.62.104.210", "178.62.104.210"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.neuralinkbrainkeycoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x2bc96b63e1fb01c3e9ec4d618087290f6e229eb91824f51837793ec476431168"))
        };
